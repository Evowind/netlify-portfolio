...
export const t = {
    ...
    // ── COMMON ───────────────────────────────────────────────────────────────
    common: {
        downloadCv:     { en: 'My resume ↓',         fr: 'Mon CV ↓' },
        viewProjects:   { en: 'See my work',          fr: 'Voir mon travail' },
    ...
    home: {
        ...
        role:       {
            en: 'I build systems that see,\nclassify, and reason.',
            fr: 'Je construis des systèmes qui voient,\nclassifient et raisonnent.',
        },
        ...
        tagline: {
            en: "M2 Computer Science · Paris · 3 years of code · 15+ projects on GitHub",
            fr: "Master Informatique · Paris · 3 ans de code · 15+ projets sur GitHub",
        },
        currentlyOn: {
            en: "Currently",
            fr: "En ce moment",
        ...
        currentlyList: {
            en: ["Writing my M2 thesis on document layout analysis", "Building this portfolio", "Learning Rust"],
            fr: ["Rédaction de mon mémoire de M2 sur l'analyse de mise en page", "Construction de ce portfolio", "Apprentissage de Rust"],
        },
    },
    ...
    competencies: {
        ...
        ai:    {
            ...
            desc: {
                    en: 'Argumentation frameworks, MiniMax, Hugging Face. Algorithmic rigour for real-world problems.',
                    fr: 'Frameworks d\'argumentation, MiniMax, Hugging Face. Rigueur algorithmique pour des problèmes réels.'
        }
        },
        res:   {
    ...
    // ── RESUME — extra keys ───────────────────────────────────────────────────
    // (merged into resume section above, keeping here for patch)

    // ── SKILLS — skill names that differ by lang ─────────────────────────────
    skillNames: {
        logicSystems:   { en: 'Logic Systems',       fr: 'Systèmes logiques' },
        systemsProg:    { en: 'Systems Programming', fr: 'Programmation système' },
        sixMonths:      { en: '6 months',            fr: '6 mois' },
    },

    // ── PROJECTS — category & status maps, FR descriptions ───────────────────
    projectMeta: {
        // Category display names
        catAll:         { en: 'All',                  fr: 'Tous' },
        catCV:          { en: 'Computer Vision',      fr: 'Vision par ordinateur' },
        catML:          { en: 'Machine Learning',     fr: 'Apprentissage automatique' },
        catWeb:         { en: 'Web Development',      fr: 'Développement Web' },
        catSystems:     { en: 'Systems Programming',  fr: 'Programmation système' },
        catDevops:      { en: 'DevOps',               fr: 'DevOps' },
        catAI:          { en: 'AI / Logic',           fr: 'IA / Logique' },
        catGame:        { en: 'Game Development',     fr: 'Jeu vidéo' },
        // Status display names
        statAll:        { en: 'All',          fr: 'Tous' },
        statCompleted:  { en: 'Completed',    fr: 'Terminé' },
        statProgress:   { en: 'In Progress',  fr: 'En cours' },
        statActive:     { en: 'Active',       fr: 'Actif' },
        // Complexity
        compAll:        { en: 'All',          fr: 'Tous' },
        compInter:      { en: 'Intermediate', fr: 'Intermédiaire' },
        compAdvanced:   { en: 'Advanced',     fr: 'Avancé' },
        // Collab label
        collab:         { en: 'Collab',       fr: 'Collab' },
    },

    // ── PROJECTS — individual descriptions ───────────────────────────────────
    projectDesc: {
        exoplanet: {
            en: 'Machine learning pipeline for detecting exoplanets from astronomical observation data. Multiple classification models, performance benchmarking, and data visualization.',
            fr: 'Pipeline ML pour la détection d\'exoplanètes à partir de données astronomiques. Plusieurs modèles de classification, benchmarking et visualisation.',
        },
        superpixel: {
            en: 'Comparison of superpixel segmentation algorithms (SLIC, hierarchical) on image datasets, with performance analysis and benchmark results.',
            fr: 'Comparaison d\'algorithmes de segmentation en superpixels (SLIC, hiérarchique) sur des jeux d\'images, avec analyse de performances.',
        },
        dockereye: {
            en: 'JavaScript tool for monitoring and managing Docker containers in real-time, with alerts and container management UI.',
            fr: 'Outil JavaScript de surveillance et gestion de conteneurs Docker en temps réel, avec alertes et interface de gestion.',
        },
        portfolio: {
            en: 'This portfolio — modern responsive Next.js website hosted on Netlify with dynamic content and SEO optimisation.',
            fr: 'Ce portfolio — site Next.js moderne et responsive hébergé sur Netlify avec contenu dynamique et optimisation SEO.',
        },
        morpion: {
            en: 'C++ Tic-tac-toe where the player draws the grid (3×3 to 5×5) using a webcam. Computer vision detects the drawn grid and runs the game.',
            fr: 'Morpion en C++ où le joueur dessine la grille (3×3 à 5×5) via webcam. La vision par ordinateur détecte la grille et lance la partie.',
        },
        distrib: {
            en: 'Tournament system with Docker, Kubernetes, and microservices architecture. Full container orchestration with comprehensive testing.',
            fr: 'Système de tournoi avec Docker, Kubernetes et architecture microservices. Orchestration complète avec suite de tests intégrés.',
        },
        mkrerset: {
            en: 'Web app tracking Mario Kart tournaments using the TrueSkill rating algorithm. Full player statistics, tournament management, and history.',
            fr: 'App web de suivi de tournois Mario Kart avec l\'algorithme TrueSkill. Statistiques joueurs, gestion de tournois et historique complet.',
        },
        docLayout: {
            en: 'Computer vision project analysing document layouts using deep learning and OCR integration. PyTorch + OpenCV pipeline for layout detection.',
            fr: 'Projet de vision par ordinateur analysant la mise en page de documents via deep learning et OCR. Pipeline PyTorch + OpenCV.',
        },
        stairway: {
            en: 'CV project detecting and counting stair steps using multiple ML models. XGBoost + Scikit-learn, edge detection, mobile-optimised.',
            fr: 'Projet de vision détectant et comptant les marches d\'escalier via plusieurs modèles ML. XGBoost + Scikit-learn, détection de contours.',
        },
        rentalcar: {
            en: 'Web app for car booking and management with full DevOps practices — CI/CD, containerisation, automated deployment.',
            fr: 'App web de réservation de voitures avec pratiques DevOps complètes — CI/CD, conteneurisation, déploiement automatisé.',
        },
        argFramework: {
            en: 'Python tool for solving argumentation frameworks with multiple semantics — admissible, stable, grounded, preferred. Graph-based reasoning engine.',
            fr: 'Outil Python pour résoudre des frameworks d\'argumentation avec plusieurs sémantiques — admissible, stable, fondée, préférée. Moteur de raisonnement par graphes.',
        },
        shapeshifter: {
            en: 'C++ real-time classifier for recognising and categorising shapes via webcam. Optimised for low-latency inference with OpenCV.',
            fr: 'Classificateur temps réel en C++ reconnaissant et catégorisant des formes via webcam. Optimisé pour l\'inférence basse latence avec OpenCV.',
        },
        champygnon: {
            en: 'Python project classifying mushrooms using scraped data. Web scraping automation, image classification, and data visualisation pipeline.',
            fr: 'Projet Python de classification de champignons à partir de données scrapées. Scraping automatisé, classification d\'images, pipeline de visualisation.',
        },
        pacman: {
            en: 'Java implementation of Pacman with design patterns (State, Observer), AI ghosts, and full JavaDoc documentation.',
            fr: 'Implémentation Java de Pacman avec patrons de conception (State, Observer), fantômes IA et documentation JavaDoc complète.',
        },
        shell: {
            en: 'Custom Unix shell implementation in C — process management, I/O redirection, piping, and built-in commands.',
            fr: 'Implémentation d\'un shell Unix en C — gestion de processus, redirection I/O, pipes et commandes intégrées.',
        },
        othello: {
            en: 'Java Othello/Reversi with MiniMax AI opponent, alpha-beta pruning, and configurable depth. Strategic gameplay with full move validation.',
            fr: 'Othello/Reversi en Java avec adversaire IA MiniMax, élagage alpha-bêta et profondeur configurable. Gameplay stratégique avec validation complète.',
        },
        admin: {
            en: 'PHP admin panel with full user management, CRUD operations, role-based access control, and authentication.',
            fr: 'Panel d\'administration PHP avec gestion des utilisateurs, opérations CRUD, contrôle d\'accès par rôle et authentification.',
        },
        pizzeria: {
            en: 'Full-stack pizzeria website with Laravel, MySQL, online ordering, and user authentication system.',
            fr: 'Site de pizzeria full-stack avec Laravel, MySQL, commande en ligne et système d\'authentification.',
        },
    },

    // ── RESUME — extra ────────────────────────────────────────────────────────
    misc: {
        more:    { en: 'More',    fr: 'Divers' },
